                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$queryRaw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT tablename FROM pg_tables WHERE schemaname='public'"], ["SELECT tablename FROM pg_tables WHERE schemaname='public'"])))];
                        case 1:
                            tablenames = _a.sent();
                            tables = tablenames
                                .map(function (_a) {
                                ...
                                .map(function (name) { return "\"public\".\"".concat(name, "\""); })
                                .join(', ');
                            if (!(tables.length > 0)) return [3 /*break*/, 3];
                            return [4 /*yield*/, this.$executeRawUnsafe("TRUNCATE TABLE ".concat(tables, " CASCADE;"))];
                        case 2:
                            _a.sent();
                            _a.label = 3;
