...
var PermissionsGuard = function () {
    ...
    var PermissionsGuard = _classThis = /** @class */ (function () {
        ...
        PermissionsGuard_1.prototype.canActivate = function (context) {
            ...
            var hasPermission = requiredPermissions.some(function (permission) {
                return user.permissions.includes(permission);
            });
            if (!hasPermission) {
                throw new common_1.ForbiddenException("Missing required permission(s): ".concat(requiredPermissions.join(', ')));
            }
            return true;
        };
