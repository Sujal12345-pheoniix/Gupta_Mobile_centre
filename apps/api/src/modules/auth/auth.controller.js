...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.login = function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.login(input)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/, {
                                    success: true,
        ...
        AuthController_1.prototype.refresh = function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var tokens;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.refreshTokens(input)];
                        case 1:
                            tokens = _a.sent();
                            return [2 /*return*/, {
                                    success: true,
        ...
        AuthController_1.prototype.logout = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.logout(user.id)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, {
                                    success: true,
        ...
        AuthController_1.prototype.forgotPassword = function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        AuthController_1.prototype.resetPassword = function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
